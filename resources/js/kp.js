/*!
 * kakao-pixel-web v0.13.1 | (c) 2018 Kakao Corp.
 * @generated 2023-06-14 17:37:31
 */
!function(e) {
    function t(r) {
        if (n[r])
...
, function(e, t, n) {
    ...
    (function(e, o) {
        ...
        (function() {
            function i(e, t) {
                function n(e) {
                    ...
                    if ("bug-string-char-index" == e)
                        ...
                        u = n("json-stringify") && n("json-parse");
                    else {
                        var i;
                        if ("json-stringify" == e) {
                            u = t.stringify;
                            ...
                            if (a) {
                                ...
                                try {
                                    a = "0" === u(0) && "0" === u(new r) && '""' == u(new o) && u(g) === y && u(y) === y && u() === y && "1" === u(i) && "[1]" == u([i]) && "[null]" == u([y]) && "null" == u(null) && "[null,null,null]" == u([y, g, null]) && '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}' == u({
                                        a: [i, !0, !1, null, "\0\b\n\f\r\t"]
                ...
                var r = e.Number || d.Number
                  ...
                  , p = e.Math || d.Math
                  , h = e.JSON || d.JSON;
                "object" == (void 0 === h ? "undefined" : u(h)) && h && (t.stringify = h.stringify,
                t.parse = h.parse);
                var _, v, y, a = a.prototype, g = a.toString, m = new f(-0xc782b5b800cec);
                try {
                ...
                if (!n("json")) {
                    ...
                    if (!m)
                        var w = p.floor
                          ...
                          , A = function(e, t) {
                            return k[t] + 365 * (e - 1970) + w((e - 1969 + (t = +(1 < t))) / 4) - w((e - 1901 + t) / 100) + w((e - 1601 + t) / 400)
                        };
                    ...
                    v = function(e, t) {
                        ...
                        for (o in r)
                            _.call(r, o) && i++;
                        return n = r = null,
                        i ? v = 2 == i ? function(e, t) {
                            var n, r = {}, o = "[object Function]" == g.call(e);
                            for (n in e)
                                o && "prototype" == n || _.call(r, n) || !(r[n] = 1) || !_.call(e, n) || t(n)
                        }
                        : function(e, t) {
                            var n, r, o = "[object Function]" == g.call(e);
                            for (n in e)
                                o && "prototype" == n || !_.call(e, n) || (r = "constructor" === n) || t(n);
                        ...
                        v = function(e, t) {
                            var n, o = "[object Function]" == g.call(e), i = !o && "function" != typeof e.constructor && c[u(e.hasOwnProperty)] && e.hasOwnProperty || _;
                            for (n in e)
                    ...
                    !n("json-stringify")) {
                        var C = {
                          ...
                          , S = function(e) {
                            for (var t = '"', n = 0, r = e.length, o = !b || 10 < r, u = o && (b ? e.split("") : e); n < r; n++) {
                          ...
                          , I = function j(e, t, n, r, o, i, a) {
                            var c, f, d, l, p, h, m, b, k;
                            try {
                                c = t[e]
                            } catch (R) {}
                            if ("object" == (void 0 === c ? "undefined" : u(c)) && c)
                                if ("[object Date]" != (f = g.call(c)) || _.call(c, "toJSON"))
                                    "function" == typeof c.toJSON && ("[object Number]" != f && "[object String]" != f && "[object Array]" != f || _.call(c, "toJSON")) && (c = c.toJSON(e));
                                else if (c > -1 / 0 && c < 1 / 0) {
                                    if (A) {
                                        for (l = w(c / 864e5),
                                        f = w(l / 365.2425) + 1970 - 1; A(f + 1, 0) <= l; f++)
                                            ;
                                        for (d = w((l - A(f, 0)) / 30.42); A(f, d + 1) <= l; d++)
                                            ;
                                        l = 1 + l - A(f, d),
                                    ...
                                    c = (0 >= f || 1e4 <= f ? (0 > f ? "-" : "+") + M(6, 0 > f ? -f : f) : M(4, f)) + "-" + M(2, d + 1) + "-" + M(2, l) + "T" + M(2, h) + ":" + M(2, m) + ":" + M(2, b) + "." + M(3, p) + "Z"
                                } else
                                    c = null;
                            if (n && (c = n.call(t, e, c)),
                            null === c)
                                return "null";
                            if ("[object Boolean]" == (f = g.call(c)))
                                return "" + c;
                            if ("[object Number]" == f)
                        ...
                        t.stringify = function(e, t, n) {
                            ...
                            if (c[void 0 === t ? "undefined" : u(t)] && t)
                                if ("[object Function]" == (a = g.call(t)))
                                    o = t;
                                else if ("[object Array]" == a) {
                                    i = {};
                                    for (var f, d = 0, l = t.length; d < l; f = t[d++],
                                    ("[object String]" == (a = g.call(f)) || "[object Number]" == a) && (i[f] = 1))
                                        ;
                                }
                            if (n)
                                if ("[object Number]" == (a = g.call(n))) {
                                    if (0 < (n -= n % 1))
                                        for (r = "",
                                        10 < n && (n = 10); r.length < n; r += " ")
                                            ;
                                } else
                                    "[object String]" == a && (r = 10 >= n.length ? n : n.slice(0, 10));
                            return I("", (f = {},
                            f[""] = e,
                            f), o, i, r, "", [])
                        }
                    ...
                    if (!n("json-parse")) {
                        var L, E, T = o.fromCharCode, O = {
                            ...
                            for (var e, t, n, r, o, u = E, i = u.length; L < i; )
                                ...
                                case 58:
                                case 44:
                                    return e = b ? u.charAt(L) : u[L],
                                    L++,
                                    e;
                                case 34:
                                    for (e = "@",
                                    L++; L < i; )
                                        if (32 > (o = u.charCodeAt(L)))
                                            D();
                                        else if (92 == o)
                                            switch (o = u.charCodeAt(++L)) {
                                            case 92:
                                            ...
                                            case 117:
                                                for (t = ++L,
                                                n = L + 4; L < n; L++)
                                                    48 <= (o = u.charCodeAt(L)) && 57 >= o || 97 <= o && 102 >= o || 65 <= o && 70 >= o || D();
                                                e += T("0x" + u.slice(t, L));
                                                break;
                                            default:
                                                D()
                                            ...
                                            if (34 == o)
                                                break;
                                            for (o = u.charCodeAt(L),
                                            t = L; 32 <= o && 92 != o && 34 != o; )
                                                o = u.charCodeAt(++L);
                                            e += u.slice(t, L)
                                        }
                                    if (34 == u.charCodeAt(L))
                                        return L++,
                                        e;
                                    D();
                                default:
                                    ...
                                    48 <= o && 57 >= o) {
                                        ...
                                        if (101 == (o = u.charCodeAt(L)) || 69 == o) {
                                            for (o = u.charCodeAt(++L),
                                            43 != o && 45 != o || L++,
                                            n = L; n < i && 48 <= (o = u.charCodeAt(n)) && 57 >= o; n++)
                                                ;
                                            n == L && D(),
                                            L = n
                                        }
                                    ...
                                    "true" == u.slice(L, L + 4))
                                        return L += 4,
                                        !0;
                                    if ("false" == u.slice(L, L + 5))
                                        return L += 5,
                                        !1;
                                    if ("null" == u.slice(L, L + 4))
                                        return L += 4,
                                        null;
                                    D()
                                }
                            ...
                            "string" == typeof e) {
                                ...
                                if ("{" == e) {
                                    for (t = {}; "}" != (e = R()); n || (n = !0))
                                        n && ("," == e ? "}" == (e = R()) && D() : D()),
                                        "," != e && "string" == typeof e && "@" == (b ? e.charAt(0) : e[0]) && ":" == R() || D(),
                                        t[e.slice(1)] = B(R());
                                    return t
                                }
                                D()
                        ...
                        t.parse = function(e, t) {
                            ...
                            "$" != R() && D(),
                            L = E = null,
                            t && "[object Function]" == g.call(t) ? K((r = {},
                            r[""] = n,
                            r), "", t) : n
                        }
                    }
            ...
            if (!l || l.global !== l && l.window !== l && l.self !== l || (d = l),
            f && !a)
                i(d, f);
            else {
                var s = d.JSON
...
, function(e, t, n) {
    ...
    function o(e) {
        ...
        "string" != typeof e || (0,
        c["default"])("" + e).length < 1)
            throw new Error("Invalid advertiser id");
        return (0,
        i["default"])(window, e, t)
    }
    t.__esModule = !0;
    var u = n(6)
      , i = r(u)
    ...
    function o(e, t) {
        ...
        return o[t] = o[t] || function(n) {
            ...
            var l = function(n) {
                ...
                (V["default"].isIOS || V["default"].isAndroid || V["default"].isDaumApp || V["default"].isKakaoTalkApp || V["default"].isAdFitInAppBrowser || V["default"].isChromeMobile) && (c.device.is_mobile = "Y",
                V["default"].isIOS ? c.device.device_type = "ios" : V["default"].isAndroid ? c.device.device_type = "android" : c.device.device_type = "unknown"),
                o.surl && (c.page.ref_url = o.surl),
                o.bidId && (c.etx_id = o.bidId),
                B["default"].hasServiceOrigin() && (c.props.service_origin = B["default"].getServiceOrigin()),
                B["default"].isLimitAdTrackingEnabled() || (c.ad_id = f || B["default"].getAdId(),
                c.ad_id || (delete c.ad_id,
                delete c.lmt));
                var d = B["default"].getKakaoAccountId();
                d && (c.accid = d.trim());
                var l = B["default"].getIDFV();
                l && (c.props.idfv = l.trim());
                var p = B["default"].getEncryptedKakaoAccountId();
                return p && (c.eacid = p.trim()),
                (0,
                Y.fetchUserAgentData)().then(function(e) {
                    if (e) {
                        var t = e.fullVersionList.filter(function(e) {
                            return /chromium/i.test(e.brand.toLowerCase())
                        })
                          , n = e.fullVersionList.filter(function(e) {
                            return /chrome|opera|edge/i.test(e.brand.toLowerCase())
                        });
                        1 === n.length ? (c.device.browser = n[0].brand,
                        c.device.browser_version = n[0].version) : 1 === t.length && (c.device.browser = t[0].brand,
                        c.device.browser_version = t[0].version),
                        "platform"in e && e.platform && (c.device.os = e.platform),
                        "platformVersion"in e && e.platformVersion && (c.device.os_version = e.platformVersion),
                        "model"in e && e.model && (c.device.model = e.model),
                        /iphone|ipad|ios/i.test(e.platform) && (c.device.device_type = "ios"),
                        /android/i.test(e.platform) && (c.device.device_type = "android"),
                        ("mobile"in e && e.mobile || /ios|android/i.test(c.device.device_type)) && (c.device.is_mobile = "Y")
                    }
                    return (0,
                    X["default"])()
                }).then(function(e) {
                    return e.appKey && e.accessToken ? (c.props.app_key = e.appKey,
                    c.props.app_access_token = e.accessToken,
                    null === B["default"].getEncryptedKakaoAccountId() && (0,
                    F["default"])(e)) : s["default"].resolve(null)
                }).then(function(e) {
                    return e && (B["default"].setEncryptedKakaoAccountId(e),
                    c.eacid = e),
                    (0,
                    i["default"])(a, c, {
                        param: "d",
              ...
              , p = function(e) {
                ...
                return new s["default"](function(r) {
                    (V["default"].isAdFitInAppBrowser || V["default"].isKakaoTalkApp) && V["default"].isIOS ? G["default"].then(function() {
                        return r(l(e, t, n))
                    })["catch"](function() {
                        return r(l(e, t, n))
                    }) : r(l(e, t, n))
...
, function(e, t, n) {
    ...
    function r(e) {
        var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
          ...
          , o = t.log
          , u = o === undefined ? function() {}
        : o;
        e._requestTimerId && (u("clear timer"),
        clearTimeout(e._requestTimerId),
        e._requestTimerId = null,
        u("override callback"),
        e.onload = e.onabort = e.onerror = null,
        e.complete || e.src === r || (u("change image src"),
        e.src = r))
    }
    function o(e) {
        var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
        ...
        var _ = encodeURIComponent(o || "param") + "=" + encodeURIComponent(JSON.stringify(t))
          , v = e + (-1 === e.indexOf("?") ? "?" : "&") + _ + "&r=i1";
        return new i["default"](function(e, n) {
            var o = new Image;
            o.onerror = o.onabort = function(e) {
                r(o),
                n(new Error("failed to send beacon: " + v))
            }
            ,
            o.onload = function() {
                clearTimeout(o._requestTimerId),
                e({
                    data: t
                })
            }
            ...
            o._requestTimerId = setTimeout(function() {
                a("aborting requests"),
                o.dispatchEvent(new Event("abort"))
            }, h),
            o.src = v
        }
        )
      ...
      , r = function() {
        ...
        f.all = function(e) {
            return new f(function(t, r) {
                ...
                if (0 === u.length)
                    return t([]);
                for (var i = u.length, a = 0; a < u.length; a++)
                    o(a, u[a])
            }
            )
        }
            ...
            purchase: function(t, n) {
                ...
                t.products instanceof Array)
                    for (var r = t.products.length - 1; r > -1; r--)
                        "object" === o(t.products[r]) && t.products[r].hasOwnProperty("id") && (t.products[r].id = "" + t.products[r].id);
                if (!(0,
                d["default"])(t.currency))
...
, function(e, t, n) {
    ...
    t["default"] = function() {
        ...
        var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : u["default"]
          , n = (0,
        f["default"])(t).purchase;
        return {
            purchaseNaverCheckout: e() || function(e) {
                (0,
                a.onClickBuyLink)(function() {
                    try {
            ...
            trackNaverCheckoutPromotionLink: e() || function(e) {
                (0,
                a.onClickPromotionLink)(function() {
                    try {
                        "function" == typeof e && e()
                    } catch (t) {}
                })
...
, function(e, t) {
    ...
    var o = window.navigator.userAgent.toLowerCase()
      ...
      , b = /bot|googlebot|crawler|spider|robot|crawling/i.test(o)
      , w = -1 !== o.indexOf("firefox")
      , k = function() {
        return l ? r() < "4.3" && !h && !w : f ? n() < "10.3" : void 0
    }();
    t["default"] = {
        isDaumApp: u,
        isKakaoTalkApp: a,
...
, function(e, t, n) {
    ...
    t.__esModule = !0,
    t.onClickPromotionLink = t.onClickTalkLink = t.onClickCartLink = t.onClickWishLink = t.onClickBuyLink = undefined;
    var o = n(25)
      , u = r(o)
      , i = n(29)
      , a = r(i);
    t.onClickBuyLink = function(e) {
        ...
        u["default"])().then(function(t) {
            return t.apiLoaded && (0,
            a["default"])(t.buyLinkButton, e)
        })
    }
    ,
    ...
    t.onClickPromotionLink = function(e) {
        ...
        u["default"])().then(function(t) {
            return t.apiLoaded && (0,
            a["default"])(t.promotionLinkButton, e)
        })
    }
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    t.__esModule = !0,
    t.loaded = t.contentLoaded = t.parsed = undefined;
    var o = n(8)
      , u = r(o)
      , i = n(27)
      , a = r(i)
    ...
    t.contentLoaded = d(window, "DOMContentLoaded", /^(?:interactive|complete)$/),
...
, function(e, t) {
    ...
    function r(e, t) {
        e && e._globalClickHandler === undefined && (e._globalClickHandler = e.onclick,
...
, function(e, t, n) {
    ...
    t["default"] = function() {
        ...
        var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : u["default"]
          , n = (0,
        c["default"])(t).purchase;
        return {
            purchasePaycoCheckout: e() || function(e) {
                (0,
                i.onClickCheckoutButton)(function() {
                    try {
            ...
            trackPaycoPromotionCheckoutButton: e() || function(e) {
                (0,
                i.onClickPromotionCheckoutButton)(function() {
                    try {
                        "function" == typeof e && e()
                    } catch (t) {}
                })
...
, function(e, t, n) {
    ...
    t.onClickPromotionCheckoutButton = function(e) {
        ...
        u["default"])().then(function(t) {
            return t.apiLoaded && (0,
            a["default"])(t.promotionCheckoutButton, e)
        })
    }
}
, function(e, t, n) {
...
, function(e, t, n) {
    ...
    var o = n(9)
      ...
      , v = {};
    t["default"] = (0,
    u["default"])(v, a["default"], f["default"], l["default"], p["default"], _["default"])
}
, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    ...
    t["default"] = function() {
        ...
        return {
            setAdId: function(t) {
                return "string" == typeof t && e.setItem("KAKAO_PIXEL_ADID", t),
                this
            },
            getAdId: function() {
            ...
            setLimitAdTrackingEnabled: function() {
                ...
                return e.setItem("KAKAO_PIXEL_ADID_LMT", t ? "Y" : "N"),
                this
            }
        }
    }()
    ...
    t["default"] = function() {
        ...
        return {
            setKakaoAccountId: function(t) {
                return "string" == typeof t && e.setItem("KAKAO_PIXEL_ACCID", t),
                this
            },
    ...
    t["default"] = function() {
        ...
        return {
            setEncryptedKakaoAccountId: function(t) {
                return "string" == typeof t && e.setItem("KAKAO_PIXEL_EACID", t),
                this
            },
...
, function(e, t, n) {
    ...
    t["default"] = function() {
        ...
        return {
            setIDFV: function(t) {
                return "string" == typeof t && e.setItem("KAKAO_PIXEL_IDFV", ("" + t).trim()),
                this
            },
            getIDFV: function() {
    ...
    t["default"] = function() {
        ...
        return {
            setServiceOrigin: function(t) {
                return "string" == typeof t && e.setItem("KAKAO_PIXEL_SERVICE_ORIGIN", ("" + t).trim()),
                this
            },
...
, function(e, t, n) {
    ...
    function r() {
        if (!i())
            return u["default"].reject(new Error("Kakao SDK가 설치되지 않았습니다."));
        try {
    ...
    t.__esModule = !0,
    t.isInstalledKakaoSdk = undefined;
    var o = n(8)
      , u = function(e) {
        return e && e.__esModule ? e : {
            "default": e
...
, function(e, t, n) {
    ...
    function o() {
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
          ...
          , l = "https://" + a + d;
        return !n && !t || !r && !o ? c["default"].resolve() : (n ? l += "/appKey/" + n : t && (l += "/appId/" + t),
        o ? l += "?appUserId=" + o : r && (l += "?accessToken=" + r),
        (0,
        i["default"])(l).then(function(e) {
            return e.eacid
        }))
    }
    t.__esModule = !0,
        ...
        return new a["default"](function(r, u) {
            try {
                ...
                l["default"])({
                    ...
                    return e ? (n("block XHR request by browser"),
                    void u(e)) : 200 !== t.statusCode ? (n("XHR request has failed"),
                    u(new Error("XHR request has failed. (statusCode=" + t.statusCode + ")"))) : (n("XHR request has done"),
                    void r(JSON.parse(o)))
                })
            } catch (i) {
                u(i)
...
, function(e, t, n) {
    ...
    function c(e) {
        ...
        var t = !1
          ...
          , r = function() {
            var e = void 0;
            if (e = c.response ? c.response : c.responseText || f(c),
            m)
                try {
                    e = JSON.parse(e)
                } catch (t) {}
          ...
          , i = function() {
            if (!l) {
                var t = void 0;
                clearTimeout(b),
                t = e.useXDR && c.status === undefined ? 200 : 1223 === c.status ? 204 : c.status;
                var o = w
                  , u = null;
                return 0 !== t ? (o = {
                    body: r(),
                ...
                c.getAllResponseHeaders && (o.headers = (0,
                p["default"])(c.getAllResponseHeaders()))) : u = new Error("Internal XMLHttpRequest Error"),
                n(u, o, o.body)
            }
        }
          , c = e.xhr || null;
        ...
        !g && e.timeout > 0 && (b = setTimeout(function() {
            if (!l) {
                l = !0,
                c.abort("timeout");
        ...
        c.setRequestHeader)
            for (d in v)
                (0,
                y["default"])(d, v) && c.setRequestHeader(d, v[d]);
    ...
    for (var g = ["get", "put", "post", "patch", "head", "delete"], m = 0, b = g.length; m < b; m++)
        !function(e, t) {
            a["delete" === g[e] ? "del" : g[e]] = function(t, n, r) {
                return n = i(t, n, r),
                n.method = g[e].toUpperCase(),
                c(n)
            }
        }(m)
}
    ...
    var r = n(8)
      ...
      , u = new o["default"](function(e) {
        var t = "readystatechange"
          , n = /^complete$/
          , r = function o() {
            n.test(document.readyState) && (document.removeEventListener(t, o),
            e())
        };
...
, function(e, t, n) {
    ...
    function o() {
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : c["default"];
        return navigator.userAgentData && navigator.userAgentData.getHighEntropyValues ? (e("use `navigator.userAgentData.getHighEntropyValues`"),
        navigator.userAgentData.getHighEntropyValues(["fullVersionList", "platform", "platformVersion", "model"])) : i["default"].resolve(null)
    }
    t.__esModule = !0,
    t.fetchUserAgentData = o;
    var u = n(8)
      , i = r(u)
      , a = n(10)
      , c = r(a)
...
, function(e, t) {
    "use strict";
    function n() {
        for (var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "", t = void 0, n = /[?&]([^=#]+)=([^&#]*)/g, r = {}; null !== (t = n.exec(e)); ) {
